...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/share/Detector.js"></script> 
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/share/imagegrid6_test.js"></script> 

<!-- Piwik -->
<script type="text/javascript">
var pkBaseURL = (("https:" == document.location.protocol) ? "https://localhost:8080/apps/piwik/" : "http://localhost:8080/apps/piwik/");
...
</script><noscript><p><img src="http://localhost:8080/apps/piwik/piwik.php?idsite=1" style="border:0" alt="" /></p></noscript>
